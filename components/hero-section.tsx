...
export default function HeroSection() {
  ...
  return (
    <div className="overflow-x-hidden bg-[#fdfaf6] text-[#2f2015] dark:bg-[#050505] dark:text-[#f5f5f5]">
      <section
        id="rituels"
          ...
          <div className="grid items-center gap-16 lg:grid-cols-12">
            <div className="relative z-10 space-y-8 lg:col-span-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#d7c4ac]/60 bg-white/80 px-4 py-2 text-sm font-medium tracking-tight text-[#8b7355] shadow-sm backdrop-blur dark:border-[#3a2b1d] dark:bg-[#0f0a07]/80 dark:text-[#d0aa78]">
                <span
                  className="inline-flex size-2 rounded-full bg-[#c29a67]"
                  aria-hidden
                />
              ...
              <h1 className="font-serif text-4xl font-bold leading-tight text-[#1a140f] md:text-5xl lg:text-[3.5rem] dark:text-white">
                La Rose de Jéricho : le miracle vivant qui renaît entre vos
                mains
              </h1>
              <p className="max-w-xl text-lg leading-relaxed text-[#5a4834] dark:text-[#b8a491]">
                Offrez-vous un rituel poétique et puissant : quelques gouttes
                d&apos;eau suffisent pour que cette plante millénaire
                s&apos;éveille, diffuse ses arômes et vous transmette ses
                bienfaits. Une expérience sensorielle, spirituelle et esthétique
                pour harmoniser votre quotidien.
              </p>
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full bg-[#c29a67] px-7 text-base font-semibold text-white shadow-lg shadow-[#c29a67]/40 transition hover:-translate-y-0.5 hover:bg-[#a67e49] dark:bg-[#d4a574] dark:text-[#2b1a0d] dark:hover:bg-[#c08d4a]"
                >
              ...
              <div className="grid gap-5 pt-8 sm:grid-cols-2 lg:grid-cols-3">
                {highlightBenefits.map(
                  ({
                    ...
                    >
                      <div
                        className="absolute inset-0 -z-10 opacity-0 transition duration-500 group-hover:opacity-100 dark:hidden"
                        style={{
                          background: `radial-gradient(120% 120% at 50% 0%, ${accentLight} 0%, transparent 65%)`,
                        }}
                        aria-hidden
                      />
                      <div
                        className="absolute inset-0 -z-10 hidden opacity-0 transition duration-500 group-hover:opacity-100 dark:block"
                        style={{
                          background: `radial-gradient(120% 120% at 50% 0%, ${accentDark} 0%, transparent 65%)`,
                        }}
                        aria-hidden
                      />
                      <div className="relative flex h-full flex-col">
                        <div
                          className={`inline-flex size-12 items-center justify-center rounded-2xl bg-[#f4e6d3]/80 shadow-inner shadow-[#caa87c]/20 ${iconTint}`}
                        >
                          <Icon className="size-6" />
                        </div>
                        <h3 className="mt-6 text-xl font-semibold tracking-tight text-[#2b1b0f] dark:text-inherit">
                          {title}
                        </h3>
                        <p className="mt-3 text-sm leading-relaxed text-[#5a4834] dark:text-[#e2cda8]">
                          {description}
                        </p>
            ...
            <div className="relative lg:col-span-6">
              ...
              <div className="relative isolate mx-auto max-w-xl rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-white/90 via-white/60 to-white/20 p-6 shadow-[0_30px_90px_rgba(81,53,28,0.16)] backdrop-blur-xl dark:border-[#1f160d] dark:from-[#0f0905]/90 dark:via-[#0d0804]/70 dark:to-[#0d0804]/30">
                ...
                <div className="absolute -right-10 top-8 hidden -rotate-3 rounded-3xl border border-[#eadac4] bg-white/90 px-5 py-4 text-sm font-medium text-[#6d5239] shadow-xl dark:border-[#2b2117] dark:bg-[#120b06]/80 dark:text-[#d4a574] lg:flex lg:flex-col lg:gap-1">
                  <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#b88a55]">
                    Sensation
                  </span>
        ...
        <div className="mx-auto mt-20 max-w-6xl">
          <InfiniteSlider className="[--duration:30s] [--gap:4rem] text-[#8b7355] opacity-80 dark:text-[#cbb392]">
            {sliderHighlights.map((highlight) => (
              <span
                key={highlight}
                className="text-sm font-medium uppercase tracking-[0.4em]"
              >
                {highlight}
              </span>
            ))}
