              ...
              <div className="relative z-10 space-y-8 lg:col-span-6">
                ...
                <div className="grid gap-5 pt-8 sm:grid-cols-2 lg:grid-cols-3">
                  {highlightBenefits.map(({ title, description, icon: Icon, accentLight, accentDark, iconTint }) => (
                    <div
                      key={title}
                      className="group relative flex aspect-[1/1.05] flex-col overflow-hidden rounded-3xl border border-[#eadac4] bg-white/90 p-5 text-[#382819] shadow-[0_25px_60px_rgba(78,52,28,0.1)] transition duration-500 dark:border-[#2a2016] dark:bg-[#100905]/90 dark:text-[#f5e2c7]"
                    >
                      ...
                      <div className="relative flex flex-1 flex-col">
                        ...
                        <h3 className="mt-5 text-xl font-semibold tracking-tight text-[#2b1b0f] dark:text-inherit">{title}</h3>
                        <p className="mt-2.5 text-sm leading-relaxed text-[#5a4834] dark:text-[#e2cda8]">{description}</p>
                        <div className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-[#d8c1a4] to-transparent opacity-0 transition duration-500 group-hover:opacity-100 dark:via-[#8a6539]" />
                      </div>
